 ...
 * @since 1.0
 */
public class DataEachValidator extends LambkitValidator {

	@Override
	protected String getTableName(Controller c) {
		return DataEach.service().getTableName();
	}
	
	@Override
	protected String getPrefix() {
		return "model";//StrKit.firstCharToLowerCase(DataEach.class.getSimpleName());
	}
}

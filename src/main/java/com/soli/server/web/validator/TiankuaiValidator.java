 ...
 * @since 1.0
 */
public class TiankuaiValidator extends LambkitValidator {

	@Override
	protected String getTableName(Controller c) {
		return Tiankuai.service().getTableName();
	}
	
	@Override
	protected String getPrefix() {
		return "model";//StrKit.firstCharToLowerCase(Tiankuai.class.getSimpleName());
	}
}

 ...
 * @since 1.0
 */
public class CatalogueValidator extends LambkitValidator {

	@Override
	protected String getTableName(Controller c) {
		return Catalogue.service().getTableName();
	}
	
	@Override
	protected String getPrefix() {
		return "model";//StrKit.firstCharToLowerCase(Catalogue.class.getSimpleName());
	}
}

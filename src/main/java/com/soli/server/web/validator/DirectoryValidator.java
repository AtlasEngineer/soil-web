 ...
 * @since 1.0
 */
public class DirectoryValidator extends LambkitValidator {

	@Override
	protected String getTableName(Controller c) {
		return Directory.service().getTableName();
	}
	
	@Override
	protected String getPrefix() {
		return "model";//StrKit.firstCharToLowerCase(Directory.class.getSimpleName());
	}
}

...
public class OpinionDirective extends LambkitDirective {
	...
	public void onRender(Env env, Scope scope, Writer writer) {
		...
		String phone = getPara("phone", scope);
		...
		OpinionService service = Opinion.service();

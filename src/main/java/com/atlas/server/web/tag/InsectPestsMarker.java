 ...
 */
/**
 * at_insect_pests标签<br>
 * 参数：{id:主键}
 * 返回值：{entity:at_insect_pests信息}
 * @author lambkit
 */
public class InsectPestsMarker extends LambkitTemplateModel {
	...
	public void onRender(Environment env, Map params, TemplateModel[] loopVars,
		...
		String host = get(params, "host");
		String address = get(params, "address");
		String harm = get(params, "harm");

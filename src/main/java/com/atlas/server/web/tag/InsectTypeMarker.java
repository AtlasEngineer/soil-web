 ...
 * at_insect_type标签<br>
 * 参数：{id:主键}
 * 返回值：{entity:at_insect_type信息}
 * @author lambkit
 */
public class InsectTypeMarker extends LambkitTemplateModel {
	...
	public void onRender(Environment env, Map params, TemplateModel[] loopVars,
		...
		String sql = " from at_insect_type where "; 
		if(wheresql == null) {
			sql += " 1=1 ";
		...
		InsectTypeService service = InsectType.service();

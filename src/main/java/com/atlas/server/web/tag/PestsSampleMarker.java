 ...
 */
/**
 * at_pests_sample标签<br>
 * 参数：{id:主键}
 * 返回值：{entity:at_pests_sample信息}
 * @author lambkit
 */
public class PestsSampleMarker extends LambkitTemplateModel {
	...
	public void onRender(Environment env, Map params, TemplateModel[] loopVars,
		...
		String sql = " from at_pests_sample where "; 
		if(wheresql == null) {
			sql += " 1=1 ";
			...
			if(StringUtils.hasText(lon)) sql += " and lon like '%" + lon + "%'";//double
		...
		PestsSampleService service = PestsSample.service();

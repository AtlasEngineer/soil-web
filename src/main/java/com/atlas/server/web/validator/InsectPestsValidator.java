 ...
 * @since 1.0
 */
public class InsectPestsValidator extends LambkitValidator {

	@Override
	protected String getTableName(Controller c) {
		return InsectPests.service().getTableName();
	}
	
	@Override
	protected String getPrefix() {
		return "model";//StrKit.firstCharToLowerCase(InsectPests.class.getSimpleName());
	}
}

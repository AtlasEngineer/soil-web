 ...
 * @since 1.0
 */
public class InsectTypeValidator extends LambkitValidator {

	@Override
	protected String getTableName(Controller c) {
		return InsectType.service().getTableName();
	}
	
	@Override
	protected String getPrefix() {
		return "model";//StrKit.firstCharToLowerCase(InsectType.class.getSimpleName());
	}
}

...
import com.atlas.server.model.base.BaseQuestion;
import com.atlas.server.model.sql.QuestionCriteria;
import com.atlas.server.service.QuestionService;
import com.atlas.server.service.impl.QuestionServiceImpl;
...
public class Question extends BaseQuestion<Question> {
	...
	public static QuestionService service() {
		return ServiceKit.inject(QuestionService.class, QuestionServiceImpl.class);
	}
	
	public static QuestionCriteria sql() {
		return new QuestionCriteria();
	}
	
	public static QuestionCriteria sql(Column column) {

...
import com.atlas.server.model.base.BaseReply;
import com.atlas.server.model.sql.ReplyCriteria;
import com.atlas.server.service.ReplyService;
import com.atlas.server.service.impl.ReplyServiceImpl;
...
public class Reply extends BaseReply<Reply> {
	...
	public static ReplyService service() {
		return ServiceKit.inject(ReplyService.class, ReplyServiceImpl.class);
	}
	
	public static ReplyCriteria sql() {
		return new ReplyCriteria();
	}
	
	public static ReplyCriteria sql(Column column) {
